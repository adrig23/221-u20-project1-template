window.addEventListener('load', () => {
  ...
  const currentStories = [ 
    new FeedItem('Dream Mom Car','This Mercedes Benz is the perfect it girl mom car with so many features. This car is a real upgrade.' ,'https://www.mbusa.com/en/vehicles/class/gls/suv', 'https://www.mbusa.com/etc/designs/mb-nafta/frontend/images/fallback/default_vehicle.jpg'),
